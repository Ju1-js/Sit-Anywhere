...
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ jungle_sapling run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ acacia_sapling run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ dark_oak_sapling run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ dandelion run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ poppy run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ blue_orchid run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ allium run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ azure_bluet run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ red_tulip run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ orange_tulip run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ white_tulip run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ pink_tulip run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ oxeye_daisy run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ cornflower run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ lily_of_the_valley run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ wither_rose run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ brown_mushroom run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ red_mushroom run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ wheat run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ carrots run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potatoes run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ beetroots run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ sugar_cane run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ pumpkin_stem run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ attached_pumpkin_stem run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ melon_stem run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ attached_melon_stem run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ lily_pad run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ nether_wart run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ cocoa run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ sweet_berry_bush run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ crimson_fungus run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ warped_fungus run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ twisting_vines run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ grass run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ fern run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ dead_bush run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ vine run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ crimson_roots run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ warped_roots run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ nether_sprouts run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ fire run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ soul_fire run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ rail run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ powered_rail run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ detector_rail run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ activator_rail run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ torch run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ soul_torch run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ wall_torch run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ soul_wall_torch run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ redstone_wire run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ redstone_torch run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ redstone_wall_torch run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ repeater run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ comparator run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ lever run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ stone_button run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ oak_button run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ spruce_button run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ birch_button run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ jungle_button run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ acacia_button run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ dark_oak_button run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ crimson_button run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ warped_button run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ polished_blackstone_button run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ tripwire_hook run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ tripwire run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ flower_pot run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_dandelion run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_poppy run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_blue_orchid run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_allium run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_azure_bluet run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_red_tulip run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_orange_tulip run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_white_tulip run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_pink_tulip run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_oxeye_daisy run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_cornflower run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_lily_of_the_valley run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_wither_rose run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_oak_sapling run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_spruce_sapling run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_birch_sapling run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_jungle_sapling run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_acacia_sapling run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_dark_oak_sapling run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_red_mushroom run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_brown_mushroom run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_fern run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_dead_bush run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_cactus run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_bamboo run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_crimson_fungus run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_warped_fungus run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_crimson_roots run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ potted_warped_roots run function simplesit:lay

execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ skeleton_skull run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ wither_skeleton_skull run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ zombie_head run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ player_head run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ creeper_head run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ dragon_head run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ skeleton_wall_skull run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ wither_skeleton_wall_skull run function simplesit:lay
execute as @a at @a if score @s SimpleLay matches 1.. if block ~ ~ ~ zombie_wall_head run function simplesit:lay
